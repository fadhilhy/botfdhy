...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Fadhil Hidayat\n' // Nama kamu
            + 'ORG:FDHY BOT;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=6282131581861:+62 812-1745-6557\n' //Nomor whatsapp kamu
            + 'END:VCARD'
const
{
WAConnection,
...
if (text.includes('.menu')) {
 var nomor = m.participant
 const options = {
       text: `*Halo @${nomor.split("@s.whatsapp.net")[0]} aku ${BotName}* 
...
͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏IG OWNER : @fadhilhidayattt_
...
//Hay gay
//Create @fadhilhidayattt_ don't delate this, please
